...
**CUSTOM LINUX DEVICE TREE**
- Refer to the official base device tree source https://github.com/altera-fpga/linux-socfpga.git - arch/arm64/boot/dts/intel/socfpga_agilex5_socdk.dts and create custom device tree with the different name. The dts file name must be different (e.g. baseline.dts) for the custom device tree (dts). 
...
build/tmp/deploy/images/<Machine Id>/baseline.dtb
```
