...
module baseline (
    ...
    output wire [2-1:0] fpga_user_leds,
    ...
    // Commented out as the devkit PHY does not support PTP.
    ...
    // Commented out as current devkit does not have USB3.1 PHY.
    ...
    assign fpga_user_leds = {heartbeat_led, fpga_leds[0]};
